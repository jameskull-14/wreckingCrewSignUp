...
import { Music, Sparkles, LogOut } from "lucide-react"
...
export default function AdminPage ({ adminInfo, onLogout }: AdminPageProps) {
                        ...
                        >
                            ...
                            <div className="flex justify-center items-center gap-4 flex-wrap">
                                <div className="flex items-center gap-3">
                                    <span className="text-amber-300 font-semibold">Admin: {adminData?.first_name || "Unknown User"}</span>
                                    {onLogout && (
                                        <Button
                                            onClick={onLogout}
                                            className="bg-gray-700 hover:bg-gray-600 text-white text-sm py-1 px-3"
                                        >
